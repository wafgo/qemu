...
/*
 * TI DMSC emulator device (TISCI minimal service)
 *
 * This device links to a TI SEC_PROXY instance and provides a minimal
...
/*
 * A tiny subset of TISCI structures.
 * We keep this "loose" on purpose, because different SoCs/firmware versions
 * vary a bit. For a minimal bring-up, you can just ACK selected message types.
 *
 * Typical TISCI message layout (word-aligned) starts with a header containing
 * type, host, seq, flags, etc.
 */
