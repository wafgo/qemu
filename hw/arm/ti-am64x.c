...
static void create_unimplemented_device_in_root(MemoryRegion *root,
  ...
  /* hole die MMIO region 0 vom SysBusDevice und mappe sie in 'root' */
...
/* 0x0000_xxxx */
    ...
    ADD_MAIN_UNIMP("EFUSE0",                             0x000300000ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("PBIST0",                             0x000310000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_PBIST",             0x000330000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("PSC0",                               0x000400000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PLLCTRL0",                           0x000410000ULL, 0x00000200ULL); /* 512 B */
    ADD_MAIN_UNIMP("ESM0_CFG",                           0x000420000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("DFTSS0",                             0x000500000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("DDPA0",                              0x000580000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("GPIO0",                              0x000600000ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("GPIO1",                              0x000601000ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("PLL0_CFG",                           0x000680000ULL, 0x00010000ULL); /* 64 KB */

/* ECC aggregators */
    ADD_MAIN_UNIMP("PSRAMECC0_ECC_AGGR0",                 0x000700000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("ECC_AGGR1_ECC_AGGR0",                 0x000701000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("USB0_ECC_AGGR0",                      0x000703000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("CPSW0_ECC0",                          0x000704000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("MMCSD0_ECC_AGGR_RXMEM",               0x000706000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("MMCSD0_ECC_AGGR_TXMEM",               0x000707000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("MMCSD1_ECC_AGGR_RXMEM",               0x000708000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("MMCSD1_ECC_AGGR_TXMEM",               0x000709000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("SA2_UL0_ECC_AGGR0",                   0x000712000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("FSS0_OSPI0_ECC_AGGR0",                0x000716000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_SS_ECC_AGGR",        0x000717000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE0_ECC_AGGR",     0x000717400ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE1_ECC_AGGR",     0x000717800ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("PCIE0_CORE_ECC_AGGR0",                0x000718000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("PCIE0_CORE_ECC_AGGR1",                0x000719000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("ADC0_ECC_REGS",                       0x00071A000ULL, 0x00000400ULL); /* 1 KB */

/* DCC */
    ADD_MAIN_UNIMP("DCC0",                                0x000800000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("DCC1",                                0x000804000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("DCC2",                                0x000808000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("DCC3",                                0x00080C000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("DCC4",                                0x000810000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("DCC5",                                0x000814000ULL, 0x00000040ULL); /* 64 B */

/* Routers + GTC/VTM */
    ADD_MAIN_UNIMP("MAIN_GPIOMUX_INTROUTER0_CFG",          0x000A00000ULL, 0x00000800ULL); /* 2 KB */
    ...
    ADD_MAIN_UNIMP("VTM0_MMR_VBUSP_CFG2",                  0x000B01000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("VTM0_ECCAGGR_CFG0",                    0x000B02000ULL, 0x00000400ULL); /* 1 KB */

/* PDMA */
    ADD_MAIN_UNIMP("PDMA0_REGS",                           0x000C00000ULL, 0x00000400ULL); /* 1 KB */
...
/* MCAN */
    ...
    ADD_MAIN_UNIMP("MCAN0_MSGMEM_RAM",                     0x020708000ULL, 0x00008000ULL); /* 32 KB */
    ADD_MAIN_UNIMP("MCAN1_SS",                             0x020710000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("MCAN1_CFG",                            0x020711000ULL, 0x00000200ULL);
    ADD_MAIN_UNIMP("MCAN1_MSGMEM_RAM",                     0x020718000ULL, 0x00008000ULL); /* 32 KB */
...
/* PRU_ICSSG0 */
    ADD_MAIN_UNIMP("PRU_ICSSG0_DRAM0_SLV_RAM",                 0x030000000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_DRAM1_SLV_RAM",                 0x030002000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU0_IRAM_RAM",             0x030004000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU1_IRAM_RAM",             0x030006000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_RAT_SLICE0_CFG",                0x030008000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_RAT_SLICE1_CFG",                0x030009000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX0_IRAM_RAM",         0x03000A000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX1_IRAM_RAM",         0x03000C000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_RAM_SLV_RAM",                   0x030010000ULL, 0x00010000ULL); /* 64 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_ICSS_INTC_SLV",             0x030020000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP0_IRAM",                0x030022000ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP0_IRAM_DEBUG",          0x030022400ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU0_IRAM",                 0x030023000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU0_IRAM_DEBUG",           0x030023400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU1_IRAM",                 0x030023800ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_RTU1_IRAM_DEBUG",           0x030023C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP1_IRAM",                0x030024000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP1_IRAM_DEBUG",          0x030024400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PROT_SLV",                  0x030024C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX0_IRAM",             0x030025000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX0_IRAM_DEBUG",       0x030025400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX1_IRAM",             0x030025800ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP_TX1_IRAM_DEBUG",       0x030025C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_CFG_SLV",                   0x030026000ULL, 0x00000200ULL); /* 512 B */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PA_STAT_WRAP_QSTAT",            0x030027000ULL, 0x00000800ULL); /* 2 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_ICSS_UART_SLV",             0x030028000ULL, 0x00000040ULL); /* 64 B */
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_PRU0_MMR0",           0x03002A000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_RTU0_MMR0",           0x03002A100ULL, 0x00000200ULL); /* 512 B */
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_PRU1_MMR0",           0x03002A200ULL, 0x00000300ULL); /* 768 B (covers 0x...2FF) */
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_RTU1_MMR0",           0x03002A300ULL, 0x00000400ULL); /* 1 KB (covers 0x...3FF) */
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_PRU_TX0_MMR0",        0x03002A400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_TASKS_MGR_PRU_TX1_MMR0",        0x03002A500ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PA_STAT_WRAP_CSTAT",            0x03002C000ULL, 0x00000800ULL); /* 2 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_IEP0",                          0x03002E000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_IEP1",                          0x03002F000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_ICSS_ECAP0_SLV",            0x030030000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_MII_RT_CFG",                0x030032000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_MII_RT_SGMII0_CFG",         0x030032100ULL, 0x00000200ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_MII_RT_SGMII1_CFG",         0x030032200ULL, 0x00000300ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_MDIO",                      0x030032400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_MII_RT_G_CFG_REGS_G0",      0x030033000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP0_IRAM_RAM",            0x030034000ULL, 0x00004000ULL); /* 16 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PR1_PDSP1_IRAM_RAM",            0x030038000ULL, 0x00004000ULL); /* 16 KB */
    ADD_MAIN_UNIMP("PRU_ICSSG0_PA_STAT_WRAP_PA_SLV",           0x03003C000ULL, 0x00000100ULL);
...
/* PRU_ICSSG1 */
    ...
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU0_IRAM_RAM",             0x030084000ULL, 0x00002000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU1_IRAM_RAM",             0x030086000ULL, 0x00002000ULL);
    ...
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX0_IRAM_RAM",         0x03008A000ULL, 0x00002000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX1_IRAM_RAM",         0x03008C000ULL, 0x00002000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_RAM_SLV_RAM",                   0x030090000ULL, 0x00010000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_ICSS_INTC_SLV",             0x0300A0000ULL, 0x00002000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP0_IRAM",                0x0300A2000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP0_IRAM_DEBUG",          0x0300A2400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU0_IRAM",                 0x0300A3000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU0_IRAM_DEBUG",           0x0300A3400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU1_IRAM",                 0x0300A3800ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_RTU1_IRAM_DEBUG",           0x0300A3C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP1_IRAM",                0x0300A4000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP1_IRAM_DEBUG",          0x0300A4400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PROT_SLV",                  0x0300A4C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX0_IRAM",             0x0300A5000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX0_IRAM_DEBUG",       0x0300A5400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX1_IRAM",             0x0300A5800ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP_TX1_IRAM_DEBUG",       0x0300A5C00ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_CFG_SLV",                   0x0300A6000ULL, 0x00000200ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PA_STAT_WRAP_QSTAT",            0x0300A7000ULL, 0x00000800ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_ICSS_UART_SLV",             0x0300A8000ULL, 0x00000040ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_PRU0_MMR0",           0x0300AA000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_RTU0_MMR0",           0x0300AA100ULL, 0x00000200ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_PRU1_MMR0",           0x0300AA200ULL, 0x00000300ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_RTU1_MMR0",           0x0300AA300ULL, 0x00000400ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_PRU_TX0_MMR0",        0x0300AA400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_TASKS_MGR_PRU_TX1_MMR0",        0x0300AA500ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PA_STAT_WRAP_CSTAT",            0x0300AC000ULL, 0x00000800ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_IEP0",                          0x0300AE000ULL, 0x00001000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_IEP1",                          0x0300AF000ULL, 0x00001000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_ICSS_ECAP0_SLV",            0x0300B0000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_MII_RT_CFG",                0x0300B2000ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_MII_RT_SGMII0_CFG",         0x0300B2100ULL, 0x00000200ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_MII_RT_SGMII1_CFG",         0x0300B2200ULL, 0x00000300ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_MDIO",                      0x0300B2400ULL, 0x00000100ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_MII_RT_G_CFG_REGS_G0",      0x0300B3000ULL, 0x00001000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP0_IRAM_RAM",            0x0300B4000ULL, 0x00004000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PR1_PDSP1_IRAM_RAM",            0x0300B8000ULL, 0x00004000ULL);
    ADD_MAIN_UNIMP("PRU_ICSSG1_PA_STAT_WRAP_PA_SLV",           0x0300BC000ULL, 0x00000100ULL);
...
/* TIMERMGR / CPTS / CBASS0 / GPMC cfg / R5F / etc */
    ADD_MAIN_UNIMP("TIMERMGR0_TIMERS",                     0x037000000ULL, 0x00040000ULL); /* 256 KB */
    ADD_MAIN_UNIMP("CPTS0",                                0x039000000ULL, 0x00000400ULL); /* 1 KB (kept here for grouping) */
    ADD_MAIN_UNIMP("CBASS0_ERR0",                          0x03A000000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("GPMC0_CFG",                            0x03B000000ULL, 0x00000400ULL); /* 1 KB */
    ...
    ADD_MAIN_UNIMP("TIMERMGR0_CONFIG",                     0x03CD00000ULL, 0x00000200ULL); /* 512 B */
...
/* SA2/DEBUGSS/ROM/STM/CTRL/FW/SEC MMR/GLB */
    ...
    ADD_MAIN_UNIMP("MAIN_SEC_MMR0_CFG0",                   0x045A00000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("CBASS_INFRA1_GLB0",                    0x045B01000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("DMASS0_CBASS_DMSC_GLB0",               0x045B03000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("CBASS0_GLB0",                          0x045B08000ULL, 0x00000400ULL); /* 1 KB */

/* DMASS0 regions (incl your example) */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_INTR0",                 0x048000000ULL, 0x00100000ULL); /* 1 MB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_IMAP0",                 0x048100000ULL, 0x00004000ULL); /* 16 KB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_CFG0",                  0x048110000ULL, 0x00000020ULL); /* 32 B */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_L2G0",                  0x048120000ULL, 0x00000400ULL); /* 1 KB */
    ADD_MAIN_UNIMP("DMASS0_PSILCFG_PROXY0",                0x048130000ULL, 0x00000200ULL); /* 512 B */
    ADD_MAIN_UNIMP("DMASS0_PSILSS_MMRS0",                  0x048140000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_UNMAP0",                0x048180000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_MCAST0",                0x048210000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_GCNTCFG0",              0x048220000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_ETLSW_MMRS0",                   0x048230000ULL, 0x00001000ULL); /* 4 KB */
    ADD_MAIN_UNIMP("DMASS0_RINGACC_GCFG0",                 0x048240000ULL, 0x00000400ULL); /* 1 KB */

    /* ADD_MAIN_UNIMP("DMASS0_SEC_PROXY_MMRS",                0x048250000ULL, 0x00000100ULL); /\* 256 B *\/ */

    ADD_MAIN_UNIMP("DMASS0_BCDMA_CRED",                    0x048400000ULL, 0x00000800ULL); /* 2 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_CRED",                   0x048410000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_BCHAN",                   0x048420000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_RFLOW",                  0x048430000ULL, 0x00004000ULL); /* 16 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_TCHAN",                  0x0484A0000ULL, 0x00004000ULL); /* 16 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_TCHAN",                   0x0484A4000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_RCHAN",                  0x0484C0000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_RCHAN",                   0x0484C2000ULL, 0x00002000ULL); /* 8 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_GCFG",                   0x0485C0000ULL, 0x00000100ULL); /* 256 B */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_GCFG",                    0x0485C0100ULL, 0x00000200ULL); /* 512 B */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_RING",                   0x0485E0000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_RING",                    0x048600000ULL, 0x00008000ULL); /* 32 KB */
    ADD_MAIN_UNIMP("DMASS0_RINGACC_RT0",                   0x049000000ULL, 0x00400000ULL); /* 4 MB */
    ADD_MAIN_UNIMP("DMASS0_RINGACC_CFG0",                  0x049800000ULL, 0x00040000ULL); /* 256 KB */
    ADD_MAIN_UNIMP("DMASS0_INTAGGR_GCNTRTI0",              0x04A000000ULL, 0x00100000ULL); /* 1 MB */
    /* ADD_MAIN_UNIMP("DMASS0_SEC_PROXY_SCFG0",               0x04A400000ULL, 0x00080000ULL); /\* 512 KB *\/ */
    /* ADD_MAIN_UNIMP("DMASS0_SEC_PROXY_RT0",                 0x04A600000ULL, 0x00080000ULL); /\* 512 KB *\/ */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_RCHANRT0",               0x04A800000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_RCHANRT0",                0x04A820000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_TCHANRT0",               0x04AA00000ULL, 0x00040000ULL); /* 256 KB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_TCHANRT0",                0x04AA40000ULL, 0x00020000ULL); /* 128 KB */
    ADD_MAIN_UNIMP("DMASS0_PKTDMA_RINGRT0",                0x04B800000ULL, 0x00400000ULL); /* 4 MB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_RINGRT0",                 0x04BC00000ULL, 0x00100000ULL); /* 1 MB */
    ADD_MAIN_UNIMP("DMASS0_BCDMA_BCHANRT0",                0x04C000000ULL, 0x00020000ULL); /* 128 KB */
    /* ADD_MAIN_UNIMP("DMASS0_SEC_PROXY_SRC_TARGET_DATA0",     0x04D000000ULL, 0x00080000ULL); /\* 512 KB *\/ */
    ADD_MAIN_UNIMP("DMASS0_RINGACC_SRC_FIFOS0",            0x04E000000ULL, 0x00400000ULL); /* 4 MB */

/* /\* Big data windows / RAM areas / caches *\/ */
/*     ADD_MAIN_UNIMP("GPMC0_DATA",                           0x050000000ULL, 0x08000000ULL); /\* 128 MB *\/ */
/*     ADD_MAIN_UNIMP("FSS0_DAT_REG1",                        0x060000000ULL, 0x08000000ULL); /\* 128 MB *\/ */
/*     ADD_MAIN_UNIMP("PCIE0_DAT0",                           0x068000000ULL, 0x08000000ULL); /\* 128 MB *\/ */

/*     ADD_MAIN_UNIMP("MSRAM_256K0_RAM",                      0x070000000ULL, 0x00040000ULL); /\* 256 KB *\/ */
/*     ADD_MAIN_UNIMP("MSRAM_256K1_RAM",                      0x070040000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K2_RAM",                      0x070080000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K3_RAM",                      0x0700C0000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K4_RAM",                      0x070100000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K5_RAM",                      0x070140000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K6_RAM",                      0x070180000ULL, 0x00040000ULL); */
/*     ADD_MAIN_UNIMP("MSRAM_256K7_RAM",                      0x0701C0000ULL, 0x00040000ULL); */

/*     ADD_MAIN_UNIMP("R5FSS0_CORE0_ICACHE",                  0x074000000ULL, 0x00800000ULL); /\* 8 MB *\/ */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE0_DCACHE",                  0x074800000ULL, 0x00800000ULL); /\* 8 MB *\/ */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE1_ICACHE",                  0x075000000ULL, 0x00800000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE1_DCACHE",                  0x075800000ULL, 0x00800000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE0_ICACHE",                  0x076000000ULL, 0x00800000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE0_DCACHE",                  0x076800000ULL, 0x00800000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE1_ICACHE",                  0x077000000ULL, 0x00800000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE1_DCACHE",                  0x077800000ULL, 0x00800000ULL); */

/*     ADD_MAIN_UNIMP("R5FSS0_CORE0_ATCM0",                   0x078000000ULL, 0x00010000ULL); /\* 64 KB *\/ */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE0_BTCM0",                   0x078100000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE1_ATCM1",                   0x078200000ULL, 0x00008000ULL); /\* 32 KB *\/ */
/*     ADD_MAIN_UNIMP("R5FSS0_CORE1_BTCM1",                   0x078300000ULL, 0x00008000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE0_ATCM0",                   0x078400000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE0_BTCM0",                   0x078500000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE1_ATCM1",                   0x078600000ULL, 0x00008000ULL); */
/*     ADD_MAIN_UNIMP("R5FSS1_CORE1_BTCM1",                   0x078700000ULL, 0x00008000ULL); */

/* /\* DDR 2GB *\/ */
/*     ADD_MAIN_UNIMP("DDR16SS0_DRAM",                        0x080000000ULL, 0x80000000ULL); /\* 2 GB *\/ */

/* /\* 4GB windows (need 64-bit hwaddr support) *\/ */
/*     ADD_MAIN_UNIMP("FSS0_DAT_REG0_4GB",                    0x4000000000ULL, 0x100000000ULL); /\* 4 GB *\/ */
/*     ADD_MAIN_UNIMP("FSS0_DAT_REG3_4GB",                    0x5000000000ULL, 0x100000000ULL); /\* 4 GB *\/ */
/*     ADD_MAIN_UNIMP("PCIE0_DAT1_4GB",                       0x6000000000ULL, 0x100000000ULL); /\* 4 GB *\/ */

/* DEBUGSS_WRAP0 region set */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_ROM_TABLE_0_0",          0x700000000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV0_0",                0x700001000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CFGAP0",                 0x700002000ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_APBAP0",                 0x700002100ULL, 0x00000200ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_AXIAP0",                 0x700002200ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_PWRAP0",                 0x700002300ULL, 0x00000400ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_PVIEW0",                 0x700002400ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_JTAGAP0",                0x700002500ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_SECAP0",                 0x700002600ULL, 0x00000100ULL); */

/* /\* Cortex cfg blocks 0..8 (each 256B) *\/ */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX0_CFG0",           0x700002700ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX1_CFG0",           0x700002800ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX2_CFG0",           0x700002900ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX3_CFG0",           0x700002A00ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX4_CFG0",           0x700002B00ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX5_CFG0",           0x700002C00ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX6_CFG0",           0x700002D00ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX7_CFG0",           0x700002E00ULL, 0x00000100ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CORTEX8_CFG0",           0x700002F00ULL, 0x00000100ULL); */

/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV1_0",                0x700003000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV2_0",                0x700004000ULL, 0x02000000ULL); /\* 32 MB *\/ */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_ROM_TABLE_1_0",          0x720000000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CSCTI0",                 0x720001000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_DRM0",                   0x720002000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV3_0",                0x720003000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CSTPIU0",                0x720004000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_CTF0",                   0x720005000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV4_0",                0x720006000ULL, 0x01000000ULL); /\* 16 MB *\/ */

/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_SS_ROM",              0x730000000ULL, 0x00010000ULL); /\* 64 KB *\/ */
/*     ADD_MAIN_UNIMP("DEBUGSS_WRAP0_EXT_APB0",               0x730000000ULL, 0x10000000ULL); /\* 256 MB *\/ */

/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE0_DBG0",          0x730010000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE0_CTI0",          0x730020000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE0_PMU0",          0x730030000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE0_ETM0",          0x730040000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE1_DBG0",          0x730110000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE1_PMU0",          0x730120000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE1_ETM0",          0x730130000ULL, 0x00010000ULL); */
/*     ADD_MAIN_UNIMP("COMPUTE_CLUSTER0_CORE1_CTI0",          0x730140000ULL, 0x00010000ULL); */

/*     ADD_MAIN_UNIMP("DEBUGSS0_ROM",                         0x73C020000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_CTSET2_WRAP_CFG",             0x73C022000ULL, 0x00002000ULL); /\* 8 KB *\/ */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ATB_REPLICATOR_CFG",          0x73C024000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_TBR_VBUSP_WRAP_TBR_CFG",      0x73C025000ULL, 0x00001000ULL); */

/* /\* ARM CTI 0..8 *\/ */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_0_CFG",               0x73C026000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_1_CFG",               0x73C028000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_2_CFG",               0x73C029000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_3_CFG",               0x73C02A000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_4_CFG",               0x73C02B000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_5_CFG",               0x73C02C000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_6_CFG",               0x73C02D000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_7_CFG",               0x73C02E000ULL, 0x00001000ULL); */
/*     ADD_MAIN_UNIMP("DEBUGSS0_ARM_CTI_8_CFG",               0x73C02F000ULL, 0x00001000ULL); */

    ADD_MAIN_UNIMP("STM0_CXSTM0",                          0x73D200000ULL, 0x00001000ULL);
    ADD_MAIN_UNIMP("STM0_CTI_CSCTI0",                      0x73D201000ULL, 0x00001000ULL);
    ADD_MAIN_UNIMP("DBGSUSPENDROUTER0_CFG",                0x73D300000ULL, 0x00000800ULL); /* 2 KB */
...
/* DEBUGSS_WRAP0 set 0_1 + 1_1 + EXT_APB1 */
    ADD_MAIN_UNIMP("DEBUGSS_WRAP0_ROM_TABLE_0_1",          0x740000000ULL, 0x00001000ULL);
...
/* Cortex cfg blocks 0..8 (each 256B) */
    ...
    ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV2_1",                0x740004000ULL, 0x02000000ULL); /* 32 MB */
    ADD_MAIN_UNIMP("DEBUGSS_WRAP0_ROM_TABLE_1_1",          0x760000000ULL, 0x00001000ULL);
    ...
    ADD_MAIN_UNIMP("DEBUGSS_WRAP0_RESV4_1",                0x760006000ULL, 0x01000000ULL); /* 16 MB */
    ADD_MAIN_UNIMP("DEBUGSS_WRAP0_EXT_APB1",               0x770000000ULL, 0x10000000ULL); /* 256 MB */
    /* ADD_MAIN_UNIMP("DMASS0_SEC_PROXY_MMRS", 0x48250000, 0x100); */
...
static void ti_am64x_realize(DeviceState *dev_soc, Error **errp) {
  ...
  memory_region_init_ram(&s->mcu_iram, NULL, "am64x.mcu.iram", MCU_IRAM_SIZE,
                         &err);
  ...
  memory_region_add_subregion(&s->mcu_root, MCU_RAT_MMIO_ADDRESS, sysbus_mmio_get_region(SYS_BUS_DEVICE(&s->rat), 0));
